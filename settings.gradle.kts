...
rootProject.name = "learn_java"
include(":beginner")
project(":beginner").projectDir = file("beginner")

include(":intermediate")
project(":intermediate").projectDir = file("intermediate")

include(":advanced")
project(":advanced").projectDir = file("advanced")